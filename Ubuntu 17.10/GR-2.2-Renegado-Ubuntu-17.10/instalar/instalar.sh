...
############################################################################# 
usuario=`whoami`
sudo apt-get --force-yes install mplayer
sudo apt-get --force-yes install ffmpeg2theora
sudo apt-get --force-yes install ffmpeg
sudo apt-get --force-yes install libav-tools
sudo apt-get --force-yes install xterm

sudo apt-get --force-yes install sox 
sudo apt-get --force-yes install libsox-fmt-all 
sudo apt-get --force-yes install gambas3
sudo apt-get --force-yes install gedit
sudo apt-get --force-yes install at
